...
namespace iLogger{
    ...
    std::size_t file_size(const string& file);
	...
	bool save_file(const string& file, const void* data, std::size_t length, bool mk_dirs = true);
    ...
    string base64_encode(const void* data, std::size_t size);
